...
When I was doing my project about inverting proton radiograms and shadowgrams, I discovered that the technique I employed can be used to make stipple pictures.
The stippling technique comes from [this paper](https://www.cs.ubc.ca/labs/imager/tr/2002/secord2002b/secord.2002b.pdf).
...
<a href="{{ site.baseurl }}/assets/voronoi-example-01.png"><img title="Example" src="{{ site.baseurl }}/assets/voronoi-example-01.png" width="300"/></a>
...
<a href="{{ site.baseurl }}/assets/voronoi-example-02.png"><img title="Example" src="{{ site.baseurl }}/assets/voronoi-example-02.png" width="300"/></a>
...
<a href="{{ site.baseurl }}/assets/jokowi-process.png"><img title="Pre-processing" src="{{ site.baseurl }}/assets/jokowi-process.png" width="700"/></a>
